...
void main() {
  ...
  group('GatePass model + workflow', () {
    test('creates pass, computes QR payload, roundtrips JSON', () {
      final pass = GatePass(
        passId: 'EVT-SINGLE_DAY-2026-000999',
        category: PassCategory.ATTENDEE,
    ...
    test('fromJson accepts Python-style compact keys (pid, nm, cat, etc)', () {
      ...
      expect(p.passId, 'EVT-MULTI_DAY-2026-000007');
    ...
    test('PassLog serializes and deserializes', () {
      final log = PassLog(
        passId: 'EVT-SINGLE_DAY-2026-000101',
        action: 'ENTRY',
        gate: 'Gate A',
        valid: true,
        notes: 'ok',
